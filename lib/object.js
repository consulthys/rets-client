 ...
 * @param index the index of the photo to retrieve (if none, defaults to all, i.e. *)
 ...
 *
 */
var getPhotos = function(resourceType, photoType, matrixId, index, callback) {
    getObject(resourceType, photoType, matrixId + ":" + (index || "*"), function(error, contentType, data) {
        var multipartBoundary = contentType.match(/boundary=(?:"([^"]+)"|([^;]+))/i)[2];
